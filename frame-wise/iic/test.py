...
parser.add_argument('--eval', default='all', type=str,
                    choices=["all","last"],
...
def main():
    ...
    if args.eval == "all":
        csv_file = "./csv/test"+str(args.val_num)+".csv"

    elif args.eval == "last":
        csv_file = "./csv/test"+str(args.val_num)+"_last.csv"    

    val_dataset = EGGDataset(csv_file=csv_file,transform=transforms.Compose([                           
                                transforms.ToTensor(),
                                normalize,
                                ]))
    ...
    with open(args.mode+'_iic_test'+str(args.val_num)+"_"+args.eval+'.csv', 'w') as f:
        writer = csv.writer(f)
